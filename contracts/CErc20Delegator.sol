...
/**
 * @title Protocol's CErc20Delegator Contract
 * @notice CTokens which wrap an EIP-20 underlying and delegate to an implementation
 * @author RBL
 */
contract CErc20Delegator is CTokenInterface, CErc20Interface, ProtocolTokenDelegatorInterface {
    /**
   ...
   /**
    ...
    function sweepToken(EIP20NonStandardInterface token) external {
        require(msg.sender == admin, 'CErc20Delegator::sweepToken: only admin may call');
