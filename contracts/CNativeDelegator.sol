...
/**
 * @title Protocol's CNativeDelegator Contract
 * @notice CTokens which wrap the native token and delegate to an implementation
 * @author RBL
 */
contract CNativeDelegator is CTokenInterface, CNativeInterface, ProtocolTokenDelegatorInterface {
    /**
    ...
    function _setImplementation(address implementation_, bool allowResign, bytes memory becomeImplementationData) public {
        require(msg.sender == admin, "CNativeDelegator::_setImplementation: Caller must be admin");
