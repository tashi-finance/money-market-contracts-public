...
contract GovernorAlpha {
    ...
    string public constant name = "Lending Market Governor Alpha";

    /// @notice The number of votes in support of a proposal required in order for a quorum to be reached and for a vote to succeed
    function quorumVotes() public pure returns (uint) { return 288000000e18; } // 288,000,000 = 4% of protocol tokens

    /// @notice The number of votes required in order for a voter to become a proposer
    function proposalThreshold() public pure returns (uint) { return 72000000e18; } // 72,000,000 = 1% of protocol tokens
    ...
    constructor(address timelock_, address governanceToken_, address guardian_) public {
    ...
    function propose(address[] memory targets, uint[] memory values, string[] memory signatures, bytes[] memory calldatas, string memory description) public returns (uint) {
        ...
        uint endTimestamp = add256(block.timestamp, add256(votingPeriod(), votingDelay()));
